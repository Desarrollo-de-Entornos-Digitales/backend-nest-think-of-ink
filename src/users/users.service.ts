...
const SEED_USERS = [
  ...
  },
  {
    ...
    email: 'diegorodriguez@ink.com',
    password: 'seed123',
    fullName: 'Diego Rodríguez',
    profession: 'Tatuador Blackwork',
    bio: 'Especialista en blackwork y geometría sagrada',
    city: 'Cali',
    avatarUrl: '/images/avatars/diego-rodriguez.png',
  },
  {
    username: 'mariagonzalez',
    email: 'mariagonzalez@ink.com',
    password: 'seed123',
    fullName: 'María González',
    profession: 'Tatuadora Fine Line',
    bio: 'Especialista en fine line y lettering',
    city: 'Cali',
    avatarUrl: '/images/avatars/maria-gonzalez.png',
  },
  {
    username: 'camilasanchez',
    email: 'camilasanchez@ink.com',
    password: 'seed123',
    fullName: 'Camila Sánchez',
    profession: 'Tatuadora Realismo',
    bio: 'Retratos realistas y arte en escala de grises',
    city: 'Medellín',
    avatarUrl: '/images/avatars/camila-sanchez.png',
  },
  {
    username: 'juanramirez',
    email: 'juanramirez@ink.com',
    password: 'seed123',
    fullName: 'Juan Ramírez',
    profession: 'Tatuador Neotradicional',
    bio: 'Arte floral y neotradicional con color',
    city: 'Cali',
    avatarUrl: '/images/avatars/juan-ramirez.png',
  },
];
