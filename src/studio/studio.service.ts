...
const SEED_STUDIOS = [
  {
    ...
    description: 'Estudio especializado en blackwork y fine line',
    city: 'Cali',
  ...
  },
  {
    ...
    description: 'Expertos en mini tatuajes con máximo detalle',
    city: 'Cali',
    address: 'Granada',
  ...
  },
  {
    ...
    description: 'Especialistas en línea fina y geométrico',
    city: 'Cali',
  ...
  {
    name: 'Neo Art Studio',
    description: 'Arte neotradicional y realismo a color',
    city: 'Cali',
    address: 'El Peñón',
  ...
  },
  {
    ...
    description: 'Estudio oscuro especializado en blackwork y horror',
    city: 'Cali',
    address: 'San Antonio',
  ...
  },
  {
    ...
    description: 'Realismo y retratos con alta fidelidad',
    city: 'Cali',
    address: 'Norte',
  ...
  {
    name: 'Ink Master',
    description: 'Estudio líder en tatuaje tradicional y neo tradicional',
    city: 'Cali',
    address: 'Centro',
  ...
  {
    name: 'Black Ink',
    description: 'Especialistas en blackwork y estilo oscuro',
    city: 'Cali',
    address: 'Sur',
